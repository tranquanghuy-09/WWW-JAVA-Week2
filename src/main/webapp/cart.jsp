...
<div class="container my-3" style="height: 900px;">
    <div class="d-flex py-3"><h3 id="total"></h3> <a class="mx-3 btn btn-primary" href="cart-check-out">Đặt hàng</a></div>
...
<!-- <div class="mua-hang">
    <p class="tieu-de-mua-hang">Mua hàng</p>
    <label for="hoTen">Họ tên</label>
    <input type="text" name="" id="hoTen">

    <label for="soDienThoai">Số điện thoại</label>
    <input type="text" name="" id="soDienThoai">
    ...
    <button class="btn-nut-mua-hang">Mua hàng</button> -->
